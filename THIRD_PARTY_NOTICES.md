...
Training uses [PyTorch](https://github.com/pytorch/pytorch) and [NumPy](https://github.com/numpy/numpy), pinned in `packages/training/pyproject.toml` and `uv.lock`. Training supervision is generated by this repository's own renderers; no third-party corpus is used to produce labels.
