...
- The honest headline accuracy number is **511/1000 on unseen sentence frames**. Held-in generated scores (4,996/5,000 and 997/1,000) share rendering families with training and must not be quoted as language accuracy. See `MODEL_CARD.md`.
